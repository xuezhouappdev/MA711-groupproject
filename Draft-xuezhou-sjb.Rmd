...
With the following codes, we extracted the IV institutions with the highest and lowest average net price. Then we observed this varibles's basic summary statistics: min, max, mean, median and standard deviation.
...
This element, as reported in the IPEDs Student Finaicial Aid component, shows the share of undergraduate students who received federal loans in a given year. It can provide important context to figures related to debt, repayment and non-repayment.We are using the code below to summarize this variable and extract the institutions with highest and lowest value. 
...
This variable recorded debt for students who have completed the education. We are using the code below to summarize this variable and extracted the institutions with largest and smallest value. 
...
To analyze the relationship between the average net cost for Title IV institutions and State, we grouped the data into the state level to take a further look. We would like to investigate the distribution of institutions ' average net price in each state.
...
##6.9 The Relashionship between the Default Rate of Loan Repayment and Post-graduation Earnings<a id="6.9"></a> 
...
##6.10 The Relashionship between Earning 6 Years from Entry and Degree Type<a id="6.10"></a> 
...
##6.11 The Relashionship among Predominant Degree, Control and Earning after 6 year of Entry<a id="6.11"></a> 
...
##6.12 The Relashionship between Predominant Degree and Control<a id="6.12"></a> 
...
#6.13 The Relashionship between Control and Median earnings of Students Working and Not Enrolled 6 Years after Entry<a id="6.13"></a> 
